...
the data themselves.
There are at least three ways to formulate \PCA, but the most astronomy-friendly
...
degeneracies) by taking the singular value decomposition (\SVD) of the matrix
and using the top-$K$ eigenvectors as $W$.
That is magical and valuable.

...Re-describe in terms of variance. And empirical variance tensor.
