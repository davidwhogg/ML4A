...
\pagestyle{headings}\markboth{\textsc{david w. hogg}}{\textsc{machine learning in astronomy}}
\renewcommand{\sectionmark}[1]{}    % punking article.cls
\renewcommand{\subsectionmark}[1]{} % punking article.cls
